...
import 'package:unitrend/resources/firebase_provider.dart';
...
class Repository {
  ...
  Future<void> addPostToDb(User currentUser, String imgUrl, String challenge) => _firebaseProvider.addPostToDb(currentUser, imgUrl, challenge);
  ...
  Future<bool> checkIfUserLikedOrNot(String userId, DocumentReference reference) => _firebaseProvider.checkIfUserLikedOrNot(userId, reference);
   ...
   Future<List<DocumentSnapshot>> retrievePosts(FirebaseUser user, String challenge) => _firebaseProvider.retrievePosts(user, challenge);

   Future<List<DocumentSnapshot>> retrieveAllPosts(FirebaseUser user) => _firebaseProvider.retrieveAllPosts(user);
