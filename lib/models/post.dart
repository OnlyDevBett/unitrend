...
class Post {
  ...
  Post({this.currentUserUid, this.imgUrl, this.caption, this.location, this.challenge, this.time, this.postOwnerName, this.postOwnerPhotoUrl});
  ...
  Post.fromMap(Map<String, dynamic> mapData) {
    ...
    this.challenge = mapData['challenge'];
